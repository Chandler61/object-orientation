...
/*
  Make a 'favoriteThings' object that contains the following keys: band, food, person, book,
   movie, 
  holiday.
  Have the values to those keys be strings that are equal to your favorite thing in that 
  category.
*/
let favoriteThings = {
  band: "none",
...
/*
  After you've made your object, use bracket or dot notation to add another key named 'car'
   with the 
  value being your favorite car and then another key named 'show' with the value being your
   favorite 
  show.
*/
favoriteThings.car = "Pagani Zonda F",
favoriteThings.show = "Parks and Req",
//Code here
...
*/
const myFirstVehicle = new Vehicle(6, 'white', 76000)
//Code Here
...
*/
const myFirstMotorcycle = new Motorcycle(2, 'grey', 2000, 'bike', true)
//Code Here 
...
*/
const firstBoaty = new Boat(8, 'grey/black', 1500, 'Bruhbosa', 'three fan', false)
//Code Here

/*
  Call the checkSeaworthiness method on your new boat
*/
firstBoaty.checkSeaworthiness()
//Code Here

/*
  Now run the performMaintenance method on your boat
*/
firstBoaty.performMaintenance()
//Code Here 
